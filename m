...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id E4823101A07
	for <lists+linux-i2c@lfdr.de>; Tue, 19 Nov 2019 08:09:59 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725873AbfKSHJ7 (ORCPT <rfc822;lists+linux-i2c@lfdr.de>);
        Tue, 19 Nov 2019 02:09:59 -0500
Received: from mail-eopbgr130083.outbound.protection.outlook.com ([40.107.13.83]:16034
        "EHLO EUR01-HE1-obe.outbound.protection.outlook.com"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1725784AbfKSHJ6 (ORCPT <rfc822;linux-i2c@vger.kernel.org>);
        Tue, 19 Nov 2019 02:09:58 -0500
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=fG9IeUhftu8Xpi5DFmyAwp0y+OecSvcsSAf3P/pnPeg=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=Mellanox.com;
 ...
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=fG9IeUhftu8Xpi5DFmyAwp0y+OecSvcsSAf3P/pnPeg=;
 b=Rkm/QUa8bbynfmqAzTbuqYPwFc/2lcEP368d6QedFVVhAaFcEsmPyC1yrg5IotjxYMrGyKkixBTHGm6mPdkC/TXHi2b3SQQj2S/kHfsziw7vayVoZTjn6DcQkGb9to7tZa9WwTrrNlIyGEH0iY4vYgkqnAzkvQGXnVoOmKHvDo8=
Received: from AM6PR05MB5224.eurprd05.prod.outlook.com (20.177.196.210) by
 AM6PR05MB6438.eurprd05.prod.outlook.com (20.179.7.143) with Microsoft SMTP
 Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.20.2451.30; Tue, 19 Nov 2019 07:07:32 +0000
Received: from AM6PR05MB5224.eurprd05.prod.outlook.com
 ([fe80::59a9:b6c3:97d8:ff0f]) by AM6PR05MB5224.eurprd05.prod.outlook.com
 ([fe80::59a9:b6c3:97d8:ff0f%3]) with mapi id 15.20.2451.031; Tue, 19 Nov 2019
 07:07:32 +0000
...
Thread-Topic: [PATCH v6 1/2] i2c: i2c-mlx: I2C SMBus driver for Mellanox
 BlueField SoC
Thread-Index: AQHVie9UCFELFLoRVEmG9llNHZC916eSI2Xg
Date:   Tue, 19 Nov 2019 07:07:31 +0000
Message-ID: <AM6PR05MB522438244E23D478059F5E8BA24C0@AM6PR05MB5224.eurprd05.prod.outlook.com>
...
In-Reply-To: <4c2f30c9c42531f816e4cabe2db33d22f73213c5.1571868492.git.kblaiech@mellanox.com>
...
x-ms-office365-filtering-correlation-id: 4daf318d-2d8e-447c-6d9c-08d76cbf2598
x-ms-traffictypediagnostic: AM6PR05MB6438:|AM6PR05MB6438:
x-ms-exchange-transport-forked: True
x-microsoft-antispam-prvs: <AM6PR05MB643883E2E54DFEADC0393FF6A24C0@AM6PR05MB6438.eurprd05.prod.outlook.com>
x-ms-oob-tlc-oobclassifiers: OLM:350;
x-forefront-prvs: 022649CC2C
x-forefront-antispam-report: SFV:NSPM;SFS:(10009020)(979002)(4636009)(366004)(396003)(136003)(346002)(376002)(39860400002)(189003)(199004)(13464003)(9686003)(99286004)(33656002)(305945005)(478600001)(81156014)(53546011)(6506007)(81166006)(14444005)(14454004)(256004)(30864003)(11346002)(25786009)(8676002)(66066001)(74316002)(55016002)(446003)(476003)(7736002)(86362001)(486006)(52536014)(66446008)(66476007)(64756008)(66556008)(71200400001)(71190400001)(66946007)(8936002)(54906003)(110136005)(102836004)(6246003)(6636002)(316002)(229853002)(76116006)(5660300002)(4326008)(2906002)(3846002)(6116002)(186003)(7696005)(26005)(76176011)(6436002)(959014)(579004)(569006);DIR:OUT;SFP:1101;SCL:1;SRVR:AM6PR05MB6438;H:AM6PR05MB5224.eurprd05.prod.outlook.com;FPR:;SPF:None;LANG:en;PTR:InfoNoRecords;MX:1;A:1;
received-spf: None (protection.outlook.com: mellanox.com does not designate
 permitted sender hosts)
x-ms-exchange-senderadcheck: 1
x-microsoft-antispam: BCL:0;
x-microsoft-antispam-message-info: 
Content-Type: text/plain; charset="us-ascii"
Content-Transfer-Encoding: quoted-printable
MIME-Version: 1.0
X-OriginatorOrg: Mellanox.com
X-MS-Exchange-CrossTenant-Network-Message-Id: 4daf318d-2d8e-447c-6d9c-08d76cbf2598
X-MS-Exchange-CrossTenant-originalarrivaltime: 19 Nov 2019 07:07:31.8486
 (UTC)
X-MS-Exchange-CrossTenant-fromentityheader: Hosted
X-MS-Exchange-CrossTenant-id: a652971c-7d2e-4d9b-a6a4-d149256f461b
X-MS-Exchange-CrossTenant-mailboxtype: HOSTED
X-MS-Exchange-CrossTenant-userprincipalname: Q/0TETiM3JMMDhhyJufEv3Kn0aWpVVIQRZqGJgubJsHAdHSNlXTIOQ5hZVtdy08CFh+eACfseDlGPVjjpaByqg==
X-MS-Exchange-Transport-CrossTenantHeadersStamped: AM6PR05MB6438
...
> To: Wolfram Sang <wsa+renesas@sang-engineering.com>; David Woods
> <dwoods@mellanox.com>; Vadim Pasternak <vadimp@mellanox.com>;
> Michael Shych <michaelsh@mellanox.com>
> Cc: Khalil Blaiech <kblaiech@mellanox.com>; linux-i2c@vger.kernel.org; ar=
m-
> soc <arm@kernel.org>
> Subject: [PATCH v6 1/2] i2c: i2c-mlx: I2C SMBus driver for Mellanox BlueF=
ield
> SoC
>=20
...
> +        help
> +          Enabling this option will add specific I2C SMBus support for M=
ellanox
> +          BlueField system.
> +
> +          This driver can also be built as a module.  If so, the module =
...
> +          called i2c-mlx.
> +
> +          This driver implements an I2C SMBus host controller and enable=
s both
...
> + * memory-mapped region whose addresses are specified in either the DT o=
r
...
> + */
> +#define CAUSE_TRANSACTION_ENDED     0x001 /* Transaction ended with
> STOP */
...
> +#define SMBUS_STATUS_READ_ERR       0x4 /* Slave's byte count > 128 byte=
s
> */
...
> +
> +/*
> + * Timeout is given in microsends. Note also that timeout handling is no=
t
> + * exact.
> + */
...
> +		 * such as block_en and pec_en. These bits MUST be submitted
> by
...
> +	 *                     LengthInBytes=3D1,   Flags=3DI2C_F_SMBUS_OPERATI=
ON
> +	 *                                            | I2C_F_READ
> +	 * ReceiveByte+PEC:    OperationCount=3D1,
> +	 *                     LengthInBytes=3D2,   Flags=3DI2C_F_SMBUS_OPERATI=
ON
> +	 *                                            | I2C_F_READ
> +	 *                                            | I2C_F_SMBUS_PEC
> +	 *
...
I suggest to use defines for operation counter assignment, instead of 1, 2,=
 3.
...
> +
> +static
> +struct mlx_i2c_resource *mlx_i2c_get_shared_resource(struct mlx_i2c_priv
> *priv,
> +						     u8 type)
> +{
...
> +		return -ENOMEM;
> +
> +	tmp_res->params =3D platform_get_resource(pdev, IORESOURCE_MEM,
> type);
> +	if (!tmp_res->params) {
...
> +	 *
> +	 *           Ticks
> +	 * Time =3D --------- x 10^9    =3D>    Ticks =3D Time x Frequency x 10=
^-9
> +	 *         Frequency
> +	 *
> +	 */
...
> +				   false, 0xffff, 16);
> +	smbus_write(priv->smbus->io, SMBUS_TIMER_SCL_LOW_SCL_HIGH,
> timer);
> +
...
> +				   true, 0xffff, 16);
> +	smbus_write(priv->smbus->io, SMBUS_TIMER_TSETUP_START_STOP,
> timer);
> +
> +	timer =3D mlx_i2c_set_timer(priv, timings->setup_data, true, 0xffff, 0)=
;
...
> +	 */
> +
> +	ret =3D device_property_read_u32(dev, "clock-frequency", &config_khz);
> +	if (ret < 0)
...
> +
> +	config_reg =3D smbus_read(gpio_res->io, I2C_GPIO_0_FORCE_OE_EN);
...
> +
> +	corepll_reg1_val =3D smbus_read(corepll_res->io, I2C_CORE_PLL_REG1);
> +	corepll_reg2_val =3D smbus_read(corepll_res->io, I2C_CORE_PLL_REG2);
> +
> +	/* Get Core PLL configuration bits */
...
> +			 */
> +			if ((addr_tmp & SMBUS_SLAVE_ADDR_MASK) =3D=3D addr) {
> +				if (addr_tmp & (1 <<
...
> +	 * data bytes if the master wrote more than SLAVE_DATA_DESC_SIZE,
> i.e,
...
Why you ignore for both read and write error code?=20
...
However many i2c drivers use it.=20
...
> +		byte_cnt =3D (read) ? I2C_SMBUS_BLOCK_MAX : data->block[0];
...
> +
> +static int mlx_i2c_acpi_probe(struct device *dev, struct mlx_i2c_priv *p=
riv)
> +{
...
Are you using kernel debug DEBUG_OBJECTS, DEBUG_OBJECTS_FREE, KASAN?
If not, please, check with his options if your remove procedure is clean.=20
Sometime it is necessary to have devm_free_irq() opposite to
devm_request_irq()  to avoid possible "use-after-free" in interrupt handler=
.
