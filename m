...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7F100343F60
	for <lists+linux-i2c@lfdr.de>; Mon, 22 Mar 2021 12:13:54 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230204AbhCVLNZ (ORCPT <rfc822;lists+linux-i2c@lfdr.de>);
        Mon, 22 Mar 2021 07:13:25 -0400
Received: from szxga05-in.huawei.com ([45.249.212.191]:14058 "EHLO
        szxga05-in.huawei.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230201AbhCVLMu (ORCPT
        <rfc822;linux-i2c@vger.kernel.org>); Mon, 22 Mar 2021 07:12:50 -0400
Received: from DGGEMS412-HUB.china.huawei.com (unknown [172.30.72.60])
        by szxga05-in.huawei.com (SkyGuard) with ESMTP id 4F3sGx6xVszNq9Y;
...
Subject: [PATCH v3 2/3] i2c: add support for HiSilicon I2C controller
Date:   Mon, 22 Mar 2021 19:10:12 +0800
Message-ID: <1616411413-7177-3-git-send-email-yangyicong@hisilicon.com>
...
+	total_cnt = DIV_ROUND_UP_ULL(ctlr->clk_rate_khz * 1000, ctlr->bus_freq_hz);
...
+	scl_fall_cnt = NSEC_TO_CYCLES(ctlr->scl_fall_time, ctlr->clk_rate_khz);
+	/* Rise edge SCL clock cycles */
+	scl_rise_cnt = NSEC_TO_CYCLES(ctlr->scl_rise_time, ctlr->clk_rate_khz);
+
...
+		ctlr->bus_freq_hz = I2C_MAX_STANDARD_MODE_FREQ;
...
+	writel(reg, ctlr->iobase + HISI_I2C_FRAME_CTRL);
+
+	sda_hold_cnt = NSEC_TO_CYCLES(ctlr->sda_hold_time, ctlr->clk_rate_khz);
+
...
+	dev_info(ctlr->dev, "speed mode %s. hw version 0x%x.\n",
