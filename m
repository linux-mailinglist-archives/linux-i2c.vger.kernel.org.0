...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id B77DE1987B4
	for <lists+linux-i2c@lfdr.de>; Tue, 31 Mar 2020 01:02:43 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729112AbgC3XCm (ORCPT <rfc822;lists+linux-i2c@lfdr.de>);
        Mon, 30 Mar 2020 19:02:42 -0400
Received: from mail-il-dmz.mellanox.com ([193.47.165.129]:52693 "EHLO
        mellanox.co.il" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S1728876AbgC3XCm (ORCPT
        <rfc822;linux-i2c@vger.kernel.org>); Mon, 30 Mar 2020 19:02:42 -0400
...
Received: from farm-1.mtbu.labs.mlnx (farm-1.mtbu.labs.mlnx [10.15.2.31])
        by mtbu-labmailer.labs.mlnx (8.14.4/8.14.4) with ESMTP id 02UN2G5q003819;
        Mon, 30 Mar 2020 19:02:16 -0400
Received: (from kblaiech@localhost)
        by farm-1.mtbu.labs.mlnx (8.14.7/8.13.8/Submit) id 02UN2G51011063;
        Mon, 30 Mar 2020 19:02:16 -0400
...
Subject: [PATCH v9 1/2] i2c: i2c-mlxbf: I2C SMBus driver for Mellanox BlueField SoC
Date:   Mon, 30 Mar 2020 19:02:11 -0400
Message-Id: <d7ae490db44e454d535671a16526c23cab5f950e.1585608633.git.kblaiech@mellanox.com>
X-Mailer: git-send-email 2.1.2
In-Reply-To: <cover.1585608633.git.kblaiech@mellanox.com>
References: <cover.1585608633.git.kblaiech@mellanox.com>
In-Reply-To: <cover.1585608633.git.kblaiech@mellanox.com>
References: <cover.1585608633.git.kblaiech@mellanox.com>
...
index 88bf750..ca4a0e3 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -10697,6 +10697,12 @@ S:	Supported
...
index 2ddca08..8bb571c 100644
--- a/drivers/i2c/busses/Kconfig
+++ b/drivers/i2c/busses/Kconfig
@@ -726,6 +726,19 @@ config I2C_LPC2K
