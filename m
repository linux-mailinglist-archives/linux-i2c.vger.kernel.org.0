...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id EC1391DC392
	for <lists+linux-i2c@lfdr.de>; Thu, 21 May 2020 02:29:44 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726853AbgEUA3o (ORCPT <rfc822;lists+linux-i2c@lfdr.de>);
        Wed, 20 May 2020 20:29:44 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37362 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726844AbgEUA3n (ORCPT
        <rfc822;linux-i2c@vger.kernel.org>); Wed, 20 May 2020 20:29:43 -0400
Received: from mail-pj1-x1044.google.com (mail-pj1-x1044.google.com [IPv6:2607:f8b0:4864:20::1044])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 54486C061A0E
        for <linux-i2c@vger.kernel.org>; Wed, 20 May 2020 17:29:42 -0700 (PDT)
Received: by mail-pj1-x1044.google.com with SMTP id t8so52099pju.3
        for <linux-i2c@vger.kernel.org>; Wed, 20 May 2020 17:29:42 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=chromium.org; s=google;
        h=from:to:cc:subject:date:message-id:mime-version
         :content-transfer-encoding;
        bh=09jgQSCxIQjU/iIAK4hgfgNWkGgiSOeBze/uqNiXuA8=;
        b=IDGfYVDXwQzesRMynQsOG4N1gxgKwPne5iVD6QpCoCv/2FvCctYqTeBgMAmZrVQSxJ
         iBJLup48W4o20uP9p9gHa3V8Kel+NESG/l60nVUaacMR1WhS534clNiB6CkNs0lZqlth
         L5cXslQECl/3N1AgfXVYjoQwEChMav6APXSf0=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:mime-version
         :content-transfer-encoding;
        bh=09jgQSCxIQjU/iIAK4hgfgNWkGgiSOeBze/uqNiXuA8=;
        b=
X-Gm-Message-State: AOAM5305ZGyJObz58r4HpzM67v+FeZ0ypKwPMnXxwNVAUj9qwOBQreuS
        jumDz74IJGhXoV1bS79YW10rLDxq8w==
X-Google-Smtp-Source: ABdhPJzpw0sqee7HHb5cQx0xxN+XyCBGmVHy5A/iaSYSZMMJeIQq1ABDlFM9kTf8dZq+/7xRIcoLeA==
X-Received: by 2002:a17:90a:3b42:: with SMTP id t2mr8318280pjf.11.1590020979077;
        Wed, 20 May 2020 17:29:39 -0700 (PDT)
Received: from idle.mtv.corp.google.com ([2620:15c:202:1:fe92:d5a8:f1c5:e510])
        by smtp.gmail.com with ESMTPSA id y22sm3097959pfc.132.2020.05.20.17.29.37
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Wed, 20 May 2020 17:29:38 -0700 (PDT)
From:   Matthew Blecker <matthewb@chromium.org>
To:     Wolfram Sang <wsa@the-dreams.de>, linux-i2c@vger.kernel.org
Cc:     Matthew Blecker <matthewb@chromium.org>,
        Harry Cutts <hcutts@chromium.org>
Subject: [PATCH v4] i2c: Add i2c-pseudo driver for userspace I2C adapters.
Date:   Wed, 20 May 2020 17:29:07 -0700
Message-Id: <20200521002907.176922-1-matthewb@chromium.org>
...
- add Reviewed-by: Harry Cutts <hcutts@chromium.org>

Changelog v3:
- i2c: replace nonseekable_open() with stream_open()

Changelog v2:
- i2c: fix ARCH=um compilation error from non-const strlen("literal")
---
 .../i2c/pseudo-controller-interface.rst       |  306 ++
 drivers/i2c/Kconfig                           |   17 +-
 drivers/i2c/Makefile                          |    1 +
 drivers/i2c/i2c-pseudo.c                      | 3202 +++++++++++++++++
 4 files changed, 3525 insertions(+), 1 deletion(-)
...
index 000000000000..2527eb5337d2
--- /dev/null
